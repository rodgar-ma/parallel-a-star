...
Comenzaremos introduciendo los conceptos matemáticos necesarios relacionados con la teoría de grafos para entender la terminología utilizada en el resto del trabajo. Introduciremos los distintos paradigmas de algoritmos búsqueda que han surgieron en la segunda mitad del siglo XX y explicaremos en detalle el funcionamiento de A*. También haremos un análisis del mismo en términos de admisibildad y optimalidad para resolver el problema del camino más corto.

A continuación, se presentarán las distintas estrategias de paralelización propuestas en la literatura, evaluando sus ventajas y limitaciones. Veremos cómo varias ideas clave han impulsado una evolución progresiva en este campo a lo largo de las últimas décadas, desembocando en diferentes formulaciones paralelas del algoritmo basadas en los modelos de memoria compartida y distribuida.


Finalmente, se expondrá el desarrollo y la implementación de tres versiones de A*: una secuencial y dos paralelas, basadas en acercamientos diferentes de paralelización, que se implementarán en un entorno de memoria compartida. Analizaremos los tiempo de ejecución obtenidos con cada estrategia y estudiaremos su comportamiento en función del número de hilos utilizados y las características del problema.
\newpage

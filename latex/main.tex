...
Finalmente, se expondrá el desarrollo e implementación de tres versiones de A*: una secuecnial y dos paralelas basadas en acercamientos diferentes de paralelización, siendo uno de ellos el algoritmo del estado del arte actual. Analizaremos los resultados obtenidos y veremos como cambian radicalemente los resultados obtenidos según el enfoque utilizado.
